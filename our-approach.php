...
$pageTitle = 'Our Approach | Gavin Advertising'; // Title of page //
$pageDescription = ''; // Title of page //
$pageCanonical = 'http://www.gavinadvertising.com/our-approach.php';
...
<div class="the-truth">
<h2>We’re devoted to<br/>
truth in branding and driving action.</h2>
<hr class="truth-hr" />
</div>
...
<div class="web-app"><p>Web</p></div>
<div class="print-app"><p>Print</p></div>
<div class="mobile-app"><p>Mobile</p></div>
